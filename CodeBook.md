This Code Book for my final project of the Getting and Cleaning Data course describes the variables, the data, and any transformations or work that you performed to clean up the data called CodeBook.md
